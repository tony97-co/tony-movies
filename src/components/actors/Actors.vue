...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gab-6">
...
<div class="text-center mt-5">
   <a href="" v-on:click.prevent="previous()" class="text-yellow-500">
        Previous
      </a>
<a href="" v-on:click.prevent="next()" class="ml-5 text-yellow-500">Next</a>
</div>
  </div>
</template>
